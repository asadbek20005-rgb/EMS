...
public class Organization : BaseCommonEntity
{
    [Key]
    [Column("id")]
    ...
    [Column("inn")]
    [MaxLength(10)]
    public string Inn { get; set; }    // Ne polnostyu zavershon !!!
    [Column("director")]
    [MaxLength(50)]
    ...
    public Country? InfoCountry { get; set; }

    [ForeignKey("city_id")]
    public int CityId { get; set; }
    public City? InfoCity { get; set; }
